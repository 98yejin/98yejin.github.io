---
layout: post
title: IBM - Introduction to Cloud, Cloud Core 수료증과 뱃지
subtitle: 
tags: [ibm, cloud, clouders, cloud core]
comments: true
---

IBMDeveloperSkillsNetwork: CC0101EN Introduction to Cloud 코스를 수강 완료했다!

아침에 일어나니 저번에 클라우더스 신청했던 지원서가 최종 지원만 되어있고 뱃지 인증이 안된 상태라고 메일이 와있어서 ㅋㅋㅋㅋㅋ 
깜짝 놀라서 수강했다!

영어강의지만 옆에 스크립트도 나오고, 그림으로도 설명해주고 말 속도도 빠르지않아서 이해하는데는 문제 없었다.

![certification](https://github.com/98yejin/98yejin.github.io/blob/master/assets/img/ibm%EC%A6%9D%EB%AA%85%EC%84%9C.PNG?raw=true)

이거는 코스 수강을 하면 받을 수 있는 인증서고

![Badge](https://github.com/98yejin/98yejin.github.io/blob/master/assets/img/ibm-%EB%B1%83%EC%A7%80.PNG?raw=true)

일정 점수 이상 받아야 받을 수 있는 뱃지다. 뱃지 못받을까봐 두근거리면서 퀴즈 풀었다.. 아니 계속 2개 고르라는걸 하나 누르고 넘겨버려서 ㅋㅋㅋㅋㅜ..


![Progress](https://github.com/98yejin/98yejin.github.io/blob/master/assets/img/progress.PNG?raw=true)

퀴즈 1에서 하나 틀리고나서부터 동영상 엄청 꼼꼼하게 봤다 ㅎㅎ.. 
그런데 퀴즈 6 3개다 맞았는데 왜 86%일까..

Final exam은 퀴즈때문에 정신 똑바로 차리고 강의를 들어서 그런지 다행히 다맞을 수 있었다(물론 2개 고르라는걸 한개만 골려서 한번 틀렸지만.. 퀴즈랑 똑같이 기회를 두번 주기때문에..! 그리고 두개중에 하나만 맞으면 almost라고 알려주고 힌트도 준다!)
